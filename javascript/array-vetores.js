...
//Para ler todos os elementos de um vetor, podemos tambem
...
//receber conteudo de cada linha no vetor
//e com o => {} informamos bloco que ira executar para
// cada linha
frutas.forEach(item => {
    console.log('Item pelo forEach ', item)
} )
//Quando precisamos do indice tambem colocamos entre
